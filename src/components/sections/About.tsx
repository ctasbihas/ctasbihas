				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
					...
					>
						...
						<div className="space-y-4 text-muted-foreground leading-relaxed">
							...
							<p>
								Over the years, I've worked on many projects,
								from landing pages to chat applications. Some I
								left behind incomplete, but each taught me
								valuable lessons. I specialize in using modern
								web technologies to transform concepts into
								effective digital solutions. I enjoy continuous
								learning and embracing new challenges in the
								fast-paced world of technology.
							</p>
							<p>
								When I'm not coding, you'll find me exploring
								new technologies, contributing to open source
								projects, or sharing my knowledge through blog
